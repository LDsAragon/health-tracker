...
Calendario personal de hábitos, registros y emociones. App de escritorio para Windows y Linux — sin servidor, sin cuentas, todo en tu máquina.
...
La app avisa sola: cuando hay una versión nueva aparece un cartel arriba con **Instalar actualización**. Descarga, hace un backup de tu base de datos, reemplaza los archivos y se reabre sola. No hay que hacer nada más.

Si preferís hacerlo a mano (o el aviso no aparece), los datos están separados de la app, así que actualizar es reemplazar la carpeta de la app sin tocar nada más.
...
- Todo está en tu máquina. Sin cuentas, sin nube; lo único que sale a internet es el chequeo de actualizaciones.
