...
const EMOTION_CONTENT = {
  ...
  "Tristeza|Desesperado": { que: "Sufrir una pérdida y sentir que no hay nada que puedas hacer al respecto (desesperanza + tristeza).", distinguir: "Suma impotencia a la pérdida; es de las formas más intensas de la tristeza.", fdef: "Atlas of Emotions" },
  ...
  "Felicidad|Pacífico":  { que: "Sentir que todo está bien y que no hay nada que necesites hacer: contento y en paz.", distinguir: "Forma tranquila y de baja activación de la felicidad (la rama «en paz» del modelo de Willcox).", fdef: "Atlas of Emotions" },
  ...
  "Felicidad|Orgulloso": { que: "Placer por un logro propio (o de alguien que querés) que querés que otros conozcan.", distinguir: "Felicidad ligada al mérito y al valor personal.", fdef: "Atlas of Emotions" },
  ...
  "Sorpresa|Efusivo":     { que: "Energía intensa que rara vez se siente leve: va de media a alta.", distinguir: "Sorpresa con activación alta que te impulsa a moverte o a expresarte.", fdef: "Atlas of Emotions" },
  "Sorpresa|Asombrado":   { que: "Asombro ante algo muy sorprendente, bello, increíble o difícil de creer.", distinguir: "Sorpresa intensa y sostenida frente a algo grandioso o difícil de creer.", fdef: "Atlas of Emotions" },
  ...
  "Disgusto|Decepcionado|Repugnante":  { que: "Asco visceral, con un impulso fuerte de retroceder o apartarte.", distinguir: "Aversión física inmediata.", fdef: "Atlas of Emotions" },
  ...
  "Disgusto|Terrible|Repulsivo":       { que: "Rechazo físico intenso: algo te repele y te hace recular.", distinguir: "Aversión que empuja a alejarte.", fdef: "Atlas of Emotions" },
  ...
  "Disgusto|Evasivo|Aversivo":         { que: "Impulso de evitar o apartarse de algo que da asco.", distinguir: "El acento está en el rechazo activo.", fdef: "Atlas of Emotions" },
  ...
  "Tristeza|Desesperado|Impotente":    { que: "Darte cuenta de que no podés evitar ni afrontar la pérdida.", distinguir: "El foco está en la falta de poder.", fdef: "Atlas of Emotions" },
  ...
  // SORPRESA
  "Sorpresa|Jubiloso|Liberado":         { que: "Alivio: el placer de que algo que te tenía en vilo (a menudo miedo) por fin afloja.", distinguir: "El júbilo viene de soltar una carga.", fdef: "Atlas of Emotions" },
  "Sorpresa|Jubiloso|Eufórico":         { que: "Deleite arrebatador: felicidad altísima, casi abrumadora.", distinguir: "El júbilo en su punto más intenso.", fdef: "Atlas of Emotions" },
  ...
  "Miedo|Asustado|Aterrado":         { que: "Miedo en su forma más intensa, que te paraliza.", distinguir: "Terror en su punto máximo.", fdef: "Atlas of Emotions" },
  "Miedo|Asustado|Espantado":        { que: "Miedo muy intenso ante algo espantoso, apenas por debajo del terror.", distinguir: "Reacción de rechazo y huida ante algo horroroso.", fdef: "Atlas of Emotions" },
